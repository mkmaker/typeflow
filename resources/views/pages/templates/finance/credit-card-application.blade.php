...
<body>
    ...
    <script>
        (function(w, d) { w.botflow_base_domain = "https://app.botflowapp.com"; w.botflow_bot_id = "a0c1ee47-4716-4fc3-b2fc-6162153e10f9"; var h = d.head || d.getElementsByTagName("head")[0]; var s = d.createElement("script"); s.setAttribute("type", "text/javascript"); s.async=true; s.setAttribute("src", "https://app.botflowapp.com/js/embed.js"); h.appendChild(s); })(window, document);
    </script>
</body>
@endsection